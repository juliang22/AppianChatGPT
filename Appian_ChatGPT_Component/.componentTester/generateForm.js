...
componentDescriptor = [{"name":["openAIConnectedSystem"],"category":["input-only"],"type":["ConnectedSystem"]},{"name":["systemMessage"],"category":["input-only"],"type":["Text"]},{"name":["initialMessage"],"category":["input-only"],"type":["Text"]},{"name":["model"],"category":["input-only"],"type":["Text"]},{"name":["temperature"],"category":["input-only"],"type":["Decimal"]},{"name":["top_p"],"category":["input-only"],"type":["Decimal"]},{"name":["n"],"category":["input-only"],"type":["Integer"]},{"name":["stop"],"category":["input-only"],"type":["Text?list"]},{"name":["max_tokens"],"category":["input-only"],"type":["Integer"]},{"name":["presence_penalty"],"category":["input-only"],"type":["Decimal"]},{"name":["frequency_penalty"],"category":["input-only"],"type":["Decimal"]},{"name":["user"],"category":["input-only"],"type":["Text"]},{"name":["style"],"category":["input-only"],"type":["Dictionary"]},{"name":["chatHeight"],"category":["input-only"],"type":["Text"]},{"name":["SAILGen"],"category":["input-output"],"type":["Text"]},{"name":["conversation"],"category":["input-output"],"type":["Dictionary?list"]}];
var defaultValues = {};
